...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-02 06:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e557caa8-501a-4b01-aad8-8e03b8a764ef.git
$ cd e557caa8-501a-4b01-aad8-8e03b8a764ef
```
